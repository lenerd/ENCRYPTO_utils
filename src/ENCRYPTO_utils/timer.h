 ...
 */
void StartRecording(const std::string& msg, ABYPHASE phase, const std::vector<std::unique_ptr<CSocket>>& sock);
 ...
 * @param sock - a vector of sockets
 */
void StopRecording(const std::string& msg, ABYPHASE phase, const std::vector<std::unique_ptr<CSocket>>& sock);
